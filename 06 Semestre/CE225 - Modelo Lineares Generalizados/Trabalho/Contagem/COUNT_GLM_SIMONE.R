...
library(readxl)
base <- read_excel("C:/Users/Simone/Desktop/Base_simone.xlsx")
summary(base)
str(base)
base<- na.omit(base)
...
boxplot(base$Pop, xlab = '', ylab = '', main = 'População ', las=1)
boxplot(base$Alfab, xlab = '', ylab = '', main = 'Alfabetização ', las=1)
boxplot(base$Frota, xlab = '', ylab = '', main = 'Frota ', las=1)
boxplot(base$PopUrb, xlab = '', ylab = '', main = 'População Urbana ', las=1)
...
g1 <- ggplot(base, aes(x=DensDem)) + geom_histogram()+ xlab('Densidade Demográfica')+ ylab('')
g2 <- ggplot(base, aes(x=Obitos)) + geom_histogram()+ xlab('Obitos')+ ylab('')
g3 <- ggplot(base, aes(x=Renda)) + geom_histogram()+ xlab('Renda')+ ylab('')
g4 <- ggplot(base, aes(x=Pop)) + geom_histogram()+ xlab('População')+ ylab('')
g5 <- ggplot(base, aes(x=Alfab)) + geom_histogram()+ xlab('Alfabetização')+ ylab('')
...
#Vamos aplicar uma transformação logaritmica nas variáveis apontadas como mais 
#assimétricas na análise descritiva:
...
g9 <- ggplot(base, aes(x=DensDem)) + geom_histogram()+ xlab('Densidade Demográfica')+ ylab('')
g10 <- ggplot(base, aes(x=Obitos)) + geom_histogram()+ xlab('Obitos')+ ylab('')
g11 <- ggplot(base, aes(x=Renda)) + geom_histogram()+ xlab('Renda')+ ylab('')
g12 <- ggplot(base, aes(x=Pop)) + geom_histogram()+ xlab('População')+ ylab('')
g13 <- ggplot(base, aes(x=Alfab)) + geom_histogram()+ xlab('Alfabetização')+ ylab('')
...
#pontos fora
hnp(m1, xlab = 'Percentil da N(0,1)', ylab = 'Resíduos', 
    main = 'Gráfico Normal de Probabilidades')

#satisfatorio
hnp(m2, xlab = 'Percentil da N(0,1)', ylab = 'Resíduos', 
    main = 'Gráfico Normal de Probabilidades')
